...
function diff_im = anisotropic_code(im, num_iter, delta_t, kappa,option)
...
%%2D convulution masks- finite differences
...
for t=1:num_iter
    %%finite difference,[(imfilter...'conv') can be replaced by conv2(....'name')]
